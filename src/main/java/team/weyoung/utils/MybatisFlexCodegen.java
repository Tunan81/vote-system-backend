...
//        dataSource.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/vote?characterEncoding=utf-8");
...
//
//        //设置根包
//        globalConfig.setBasePackage("team.weyoung");
//
//        //设置表前缀和只生成哪些表
//        //globalConfig.setTablePrefix("tb_");
//        globalConfig.setGenerateTable("competition", "contestant_info","match_info","voting");
//
